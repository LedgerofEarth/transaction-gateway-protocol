# TGP-00 v3.4-ZK Extension Specification
...
GATEWAY_ZK_VERIFIER_ADDRESS=0x016482e1F17752e6Df63AcD54f5a9D4c1076d3a7

# RPC endpoint for verification (required)
GATEWAY_RPC_URL_943=https://rpc.v4.testnet.pulsechain.com
```
...
- **[ZKB01]** ZKB-01 Circuit Specification (Buyer Commitment Proof)
...
### C.2 Gateway Configuration

- [ ] Set `GATEWAY_ZK_VERIFIER_ADDRESS` environment variable
- [ ] Configure RPC endpoint for verification calls
- [ ] Test verifier initialization at gateway startup
- [ ] Verify gateway handles both legacy and ZK messages

### C.3 Wallet Integration

- [ ] Add ZK proof generation capability
- [ ] Implement proof normalization
- [ ] Add UI toggle for privacy mode
- [ ] Test end-to-end with gateway
