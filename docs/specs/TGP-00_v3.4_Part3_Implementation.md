...
- In CPW (CoreProve Wallet)
- In CPE (CoreProve Extension)
...
- CPW/CPE v3.4+ must emit TGP v3.4 with `preview_hash`
- Merchant Portal must support preview display
- Integrations must handle ACK with `preview_hash`
- TBC should log v3.3 usage for monitoring
