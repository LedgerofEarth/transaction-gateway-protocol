...
**An Open-Source Protocol for Trust-Minimized Blockchain Commerce**
...
- **Reference Implementation:** CoreProve suite (CPE/CPW/TBC/Contracts)
...
- **License:** Open-source (pending license selection)
- **Governance:** Community-driven with CoreProve as initial maintainer
- **Reference Implementation:** CoreProve suite (CPE/CPW/TBC/Contracts)
...
The CoreProve implementation provides reference implementations for:

- **CoreProve Extension (CPE)** — Browser-based wallet client
- **CoreProve Wallet (CPW)** — Standalone wallet application
- **Transaction Border Controller (TBC)** — Gateway/routing service
- **CoreProve Merchant Portal (MP)** — Merchant management interface
...
The **CoreProve suite** provides the first complete reference implementation:

| Component | Role | Implementation |
|-----------|------|----------------|
| **CPE/CPW** | Wallet client | Browser extension & standalone app |
| **TBC** | Gateway service | Rust-based routing & settlement coordinator |
| **Merchant Portal** | Seller interface | Web-based merchant management |
| **Contracts** | Settlement layer | Solidity smart contracts for escrow |
